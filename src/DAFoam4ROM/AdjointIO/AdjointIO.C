...
label AdjointIO::isDensityBasedSolver() const
{
    ...
    wordReList densityBasedSolverWordReList
    {
        {"rhoCentral.*", wordRe::REGEX}
    };
    wordRes densityBasedSolverWordRes(densityBasedSolverWordReList);

    if (densityBasedSolverWordRes(solverName))
    {
        return 1;
    }
    else
