...
corners[0,0,:] = [-0.010,0.000,0.049]
corners[0,1,:] = [-0.010,0.000,0.340]
corners[0,2,:] = [-0.010,0.200,0.049]
corners[0,3,:] = [-0.010,0.200,0.340]
corners[0,4,:] = [ 0.100,0.000,0.049]
corners[0,5,:] = [ 0.100,0.000,0.340]
corners[0,6,:] = [ 0.100,0.200,0.049]
corners[0,7,:] = [ 0.100,0.200,0.340]

corners[1,0,:] = [ 0.100,0.000,0.049]
corners[1,1,:] = [ 0.100,0.000,0.340]
corners[1,2,:] = [ 0.100,0.200,0.049]
corners[1,3,:] = [ 0.100,0.200,0.340]
corners[1,4,:] = [ 0.843,0.000,0.049]
corners[1,5,:] = [ 0.843,0.000,0.340]
corners[1,6,:] = [ 0.843,0.200,0.049]
corners[1,7,:] = [ 0.843,0.200,0.340]

corners[2,0,:] = [0.843,0.000,0.049]
corners[2,1,:] = [0.843,0.000,0.340]
corners[2,2,:] = [0.843,0.200,0.049]
corners[2,3,:] = [0.843,0.200,0.340]
corners[2,4,:] = [1.050,0.000,0.049]
corners[2,5,:] = [1.050,0.000,0.246]
corners[2,6,:] = [1.050,0.200,0.049]
corners[2,7,:] = [1.050,0.200,0.246]
