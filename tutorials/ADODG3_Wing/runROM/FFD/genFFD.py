...
corners[0, 0, :] = [-0.005, -0.02, 0.0]
corners[0, 1, :] = [-0.005, -0.02, 0.93]
corners[0, 2, :] = [-0.005, 0.02, 0.0]
corners[0, 3, :] = [-0.005, 0.02, 0.93]
corners[0, 4, :] = [0.305, -0.02, 0.0]
corners[0, 5, :] = [0.305, -0.02, 0.93]
corners[0, 6, :] = [0.305, 0.02, 0.0]
corners[0, 7, :] = [0.305, 0.02, 0.93]
